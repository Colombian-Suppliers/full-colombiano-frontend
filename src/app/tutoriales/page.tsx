...
const TutorialsPage = () => {
  const items = Array.from({ length: 9 }).map((_, i) => ({
    ...
    title: `Tutorial ${i + 1}`,
    summary:
      'Guia paso a paso para vendedores y compradores. Mejores practicas y recomendaciones.',
        ...
        <section className="relative h-[220px] md:h-[260px] overflow-hidden">
          ...
          <div className="relative z-10 h-full flex items-center">
            <div className="container mx-auto px-4 lg:px-8">
              ...
              <p className="text-[#C5A028] mt-2">Guias y mejores practicas</p>
            </div>
          </div>
        </section>
              ...
              {items.map((it) => (
                ...
                >
                  ...
                  <div className="p-4">
                    ...
                    <p className="text-gray-600 text-sm">{it.summary}</p>
                    <div className="mt-4">
