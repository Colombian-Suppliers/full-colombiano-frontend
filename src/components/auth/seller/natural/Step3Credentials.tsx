...
const RegisterStep5NaturalCredentials = ({
  register,
  errors,
  watch,
  back,
  ...
  return (
    <div className="space-y-4 animate-slide-up">
      ...
      {/* Primera fila: Correo electrónico */}
          ...
          options={[
            {
              ...
              description:
                'Acepto los términos de servicio y condiciones de uso',
              validation: {
      ...
      <div className="flex justify-between mt-6">
        <Button
          ...
          onClick={back}
          variant="outline"
          className="h-12 rounded-xl border-2 hover:shadow-md transition-all duration-300"
        >
          ← Atrás
        </Button>
        <Button
...
export default RegisterStep5NaturalCredentials;
